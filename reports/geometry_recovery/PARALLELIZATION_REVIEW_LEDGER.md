...
## 2026-08-28 12:40 EDT — Activation runtime pass and Bateman v5 setup retirement

- Serial/root-owned: only the direct-90 geometry exporter remains on the geometry critical path. The 45° source is provenance-only; there is no second transport or activation campaign.
